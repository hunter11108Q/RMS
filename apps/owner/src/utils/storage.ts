...
export const STORAGE_KEYS = {
  ACCESS_TOKEN:     'rms_owner_access_token',
  REFRESH_TOKEN:    'rms_owner_refresh_token',
  USER:             'rms_owner_user',
  BRANCH:           'rms_owner_branch',
  DASHBOARD_CACHE:  'rms_owner_dashboard_cache',
  OFFLINE_QUEUE:    'rms_owner_offline_queue',
} as const;
